...
export default function MortgageCalculator() {
  return (
    <>
      ...
      <section className="lg:container md:mx-auto md:mx-0 w-full h-full md:max-w-full flex flex-col pt-16 px-8">
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          <div className="bg-white p-6 rounded-[8px] shadow col-span-1 space-y-4 border-gray">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
              ...
              <div className="flex flex-col justify-between">
                <label htmlFor="firstPaymentDate" className="block font-medium">
                  First Payment Date
                </label>
                <input
                  id="firstPaymentDate"
          ...
          <div className="flex mt-4 border-b border-gray-300">
            <button className="flex-1 text-[#4296EA] border-b-2 border-[#4296EA] px-4 py-2 text-center cursor-pointer">
              Past & Current Analysis
            </button>
            <button className="flex-1 text-gray-400 px-4 py-2 text-center cursor-pointer">
              Predictive Analysis
            </button>
          </div>
      ...
      <section className="lg:container bg-gray-100 md:mx-auto md:mx-0 w-full h-full md:max-w-full flex flex-col pt-8 pb-16 px-8">
        <div className="space-y-6 rounded-lg text-center">
          {/* <!-- Charts Section --> */}
          ...
          <div className="bg-white p-6 rounded-lg shadow border-gray">
            ...
            <h1 className="text-3xl font-bold">
              Use the same table that used in Loans Page
            </h1>
          </div>
        </div>
      </section>
      ...
      <section className="lg:container md:mx-auto md:mx-0 w-full h-full md:max-w-full flex flex-col pt-16 px-8">
        ...
        <div className="flex justify-center space-x-4 mb-5">
          <button className="px-4 py-2 rounded border border-gray-300 text-sm">
            Purchase
          </button>
          <button className="px-4 py-2 rounded border border-gray-300 text-sm">
            Refinance
          </button>
          <button className="px-4 py-2 rounded bg-[#0A2540] text-white text-sm">
            Data Analysis
          </button>
        </div>
        <p className="text-center max-w-xl mx-auto text-sm">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore
        </p>
        <div className="flex mt-4 border-b border-gray-300">
      ...
      <section className="lg:container bg-gray-100 md:mx-auto md:mx-0 w-full h-full md:max-w-full flex flex-col pt-8 pb-16 px-8">
        {/* <!-- Analysis Card --> */}
        <div className="bg-white shadow-sm rounded-xl p-6 text-center space-y-4">
          <h6 className="text-xl">01</h6>
          <h2 className="text-xl sm:text-2xl font-bold mb-1">
            Is It The Right Time To Get A Mortgage?
          </h2>
          <p className="text-sm mb-20">
            Compare today's rates with the 15-year historical average to make
            smarter decisions
          </p>

          <div className="mt-6">
            <h3 className="text-lg sm:text-lg font-semibold">Current Rate:</h3>
            <p className="text-2xl sm:text-4xl font-semibold">6.20%</p>
            <p className="text-sm">(Above 15-year average)</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
            ...
            <div className="shadow p-4 rounded-lg">
              <h4 className="font-medium text-sm">North Carolina</h4>
              <p className="text-xl sm:text-2xl font-semibold mt-1">5.95%</p>
              <p className="text-xs mt-1">
                Today's lowest average by state
              </p>
            </div>

            {/* <!-- DCU --> */}
            <div className="shadow p-4 rounded-lg">
              <h4 className="font-medium text-sm">DCU</h4>
              <p className="text-xl sm:text-2xl font-semibold mt-1">5.85%</p>
              <p className="text-xs mt-1">
                5 options, available nationally
              </p>
            </div>

            {/* <!-- National Average --> */}
            <div className="shadow p-4 rounded-lg">
              <h4 className="font-medium text-sm">National Average</h4>
              <p className="text-xl sm:text-2xl font-semibold mt-1">6.20%</p>
              <p className="text-xs mt-1">
                based on today's data from FRED
              </p>
            </div>
          </div>
        </div>
