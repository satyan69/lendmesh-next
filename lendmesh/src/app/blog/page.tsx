    ...
    <>
      <div className="bg-[#002144] page-banner loans-banner">
        <section className="lg:container md:mx-auto md:mx-0 w-full h-full md:max-w-full flex flex-col items-center justify-center  text-white text-center py-16 px-6">
          <h1 className="mt-6 text-4xl sm:text-5xl font-bold">Blogs</h1>
      ...
      <div className="loans-section-1-wrapper">
        <section className="lg:container md:mx-auto md:mx-0 w-full h-full md:max-w-full pt-16">
          <div className="flex flex-wrap gap-2 mb-6">
            ...
            <button className="px-4 py-2 rounded-[8px] border border-blue-900 text-blue-900">
              Personal
            </button>
            <button className="px-4 py-2 rounded-[8px] border border-blue-900 text-blue-900">
              Vehicle
      ...
      <div className="loans-section-1-wrapper">
        <section className="lg:container md:mx-auto md:mx-0 w-full h-full md:max-w-full pt-16">
          <div className="px-4 py-8 grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            {/* <!-- Newsletter Section --> */}
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <input
                  ...
                  className="px-4 py-2 border border-blue-900 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-200 w-full sm:w-auto"
                />
                <button className="bg-blue-900 text-white px-6 py-2 rounded-md font-semibold hover:bg-blue-800 transition">
                  Subscribe now
                </button>
              </div>
            </div>
